...
from scad_generator import disk_guard_diameter, generate_scad
...
def test_geometry_contract_and_connected_anchors():
    ...
    assert "translate([0, guard_center_y, 0]) guard();" in scad
...
def test_geometry_audit_reports_normal_contacts_and_orientation():
    ...
    assert "faces +Y toward the blade" in combined
